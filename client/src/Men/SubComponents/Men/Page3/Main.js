...
import "../../../PageComponents/Women/page1.css";
import { useCart } from "../../../../context/Cart";
import { useAuth } from "../../../../context/Author";

function Main({ data, filter }) {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center lg:justify-between items-end md:pt-36 md:px-12">
      ...
      <div className="px-4 md:px-0 w-full md:w-5/12 lg:w-4/12 text-[12px]">
        ...
        <p className="font-light w-10/12 mb-4">
          Long sleeve with adjustable hood. Front pouch pocket. Faded and
          ripped effect all over the garment. Ribbed trims. Featuring front welt pockets and front button fastening.
        </p>
        ...
        {/* <div>
          <button
            onClick={() => {
              ...
              localStorage.setItem('cart', JSON.stringify([...cart, itemData[0]]));
              setO(showDrawer);
