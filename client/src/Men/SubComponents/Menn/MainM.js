...
<div
    ...
    <div className="px-4 md:px-0 w-full md:w-5/12 lg:w-4/12 text-[12px]">
      ...
      Relaxed fit shirt made of a creased effect fabric. Camp collar and short sleeves. Split hem. Button-up front.
      </p>
      <p className="font-light text-[10px] mb-1">FUCHSIA | 0761/469</p>
